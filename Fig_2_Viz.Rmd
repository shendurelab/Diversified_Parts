...
ggplot(BB_Above_Standard, aes(x = log2(Fold_Change_Over_Standard), y = fct_reorder(Oligo_Number, Fold_Change_Over_Standard), fill = Oligo_Number)) +
  ...
  scale_fill_manual(values=c("black", "#56B4E9", "#56B4E9", "#56B4E9", "#56B4E9", "#56B4E9", "#56B4E9", "#56B4E9")) +
  theme_classic() +
  ...
  labs(title = "", x = "", y = "") +
  theme(legend.position = "none") +
  theme(text = element_text(family="Arial", colour = "black", size = 32))
ggsave("BB_Top_Part_Boxplot.jpeg", width = 6, height = 13.5, path = "/Users/troymcdiarmid/Documents/U6_pro_series/Figs/Pub_Figs/")
